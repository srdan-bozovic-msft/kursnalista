...
namespace MSC.Universal.Shared.Contracts.Repositories
{
    public class RepositoryResult<T>
    {
        ...
        public static RepositoryResult<T> Create(T value, bool isCurrent = true, bool successful = true, int errorCode = 0, string errorMessage = null, Exception xcp = null)
        {
            return new RepositoryResult<T>(value, isCurrent, successful, errorCode, errorMessage, xcp);
        }
        ...
        protected RepositoryResult(T value, bool isCurrent, bool successful, int errorCode, string errorMessage, Exception xcp)
        {
            Value = value;
            IsCurrent = isCurrent;
