    ...
    public abstract class SinglePageViewModel : ViewModel, IPageViewModel
    {
        ...
        public async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode == NavigationMode.New)
            {
                ...
                NavigatedTo();
                OnNavigatedToView(true);
                OnNavigatedForwardToView();
            }
            else
            {
        ...
        protected virtual void OnNavigatedToView(bool forwardNavigation)
        {

        }

        protected virtual void OnNavigatedForwardToView()
        {
